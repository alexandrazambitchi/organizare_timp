...
class _GroupPageState extends State<GroupPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     appBar: AppBar(
        leading: IconButton(icon: Icon(Icons.home), onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Button(
                              onTap: () {
                                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const GroupEditPage()));
                              },
                              text: "Creaza grup"
                              ),
                            const SizedBox(
                            ...
                            Button(
                              onTap: () {
                                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const JoinGroupPage()));
                            
                              },
                              text: "Alatura-te unui grup"),
                            Button(onTap: () {
                              Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const GroupListPage()));
